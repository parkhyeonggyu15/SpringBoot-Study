package com.example.demo.외부API연동.C07CollSMS;
...
public class CoolSmsController {
    ...
    private String API_KEY = "NCSZQPGSWTIQ8SNQ";       // 솔라피 API Key
    private String API_SECRET = "YREOPCCUEBHAHSJVAHVB1ZDOHNKJGP9W";    // 솔라피 API Secret
    private String FROM = "01023753058";          // 사전 등록된 발신번호 (예: 01012345678)
