...
class ExReplyRepositoryTest {
    ...
    public void t1(){
        ...
        exReplyRepository.save(new ExReply(null,"board id 1의 댓글1",board1));
        exReplyRepository.save(new ExReply(null,"board id 1의 댓글2",board1));
        exReplyRepository.save(new ExReply(null,"board id 1의 댓글3",board1));

        // ExBoard id=2 인 게시물 Reply
        ExBoard board2 = exBoardRepository.findById(2L).get();

        exReplyRepository.save(new ExReply(null,"board id 2의 댓글1",board2));
        exReplyRepository.save(new ExReply(null,"board id 2의 댓글2",board2));
        exReplyRepository.save(new ExReply(null,"board id 2의 댓글3",board2));
    }
}