...
import com.example.demo.Config.auth.handler.provider.GoogleUserInfo;
import com.example.demo.Config.auth.handler.provider.KakaoUserInfo;
import com.example.demo.Config.auth.handler.provider.NaverUserInfo;
import com.example.demo.Config.auth.handler.provider.OAuth2UserInfo;
...
//        System.out.println("Provider Name : " + userRequest.getClientRegistration().getClientName());
        ...
        if(provider.startsWith("Kakao")){
            System.out.println("OAUTH2 PRIVIDER : KAKAO");
...
//            System.out.println("connected at : "+connected_at);
...
//            System.out.println("kakao_account : "+kakao_account);
            ...
            System.out.println("OAUTH2 PRIVIDER : NAVER");
            username = oAuth2UserInfo.getProvider()+"_"+oAuth2UserInfo.getProviderId();

        }else if(provider.startsWith("Google")){
            System.out.println("OAUTH2 PRIVIDER : GOOGLE");
        ...
        // OAuth2 계정정보를 바탕으로 로컬계정 생성(접속 최초 1회만)
